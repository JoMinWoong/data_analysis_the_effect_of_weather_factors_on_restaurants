...
QUALIFY ROW_NUMBER() OVER (PARTITION BY s_yb.state, s_yb.postal_code, s_yb.city, s_yb.address ORDER BY s_yb.state, s_yb.postal_code, s_yb.city, s_yb.address) = 1;
...
SELECT s_yu.user_id, s_yu.name, s_yu.review_count, s_yu.yelping_since, s_yu.useful, s_yu.funny, s_yu.cool, s_yu.elite, s_yu.friends,
       s_yu.fans, s_yu.average_stars, s_yu.compliment_hot, s_yu.compliment_more, s_yu.compliment_profile, s_yu.compliment_cute,
       s_yu.compliment_list, s_yu.compliment_note, s_yu.compliment_plain, s_yu.compliment_cool, s_yu.compliment_funny,
       s_yu.compliment_writer, s_yu.compliment_photos
FROM STAGE.yelp_user AS s_yu
...
SELECT  s_yr.review_id, s_yr.user_id, s_yr.business_id, s_yr.stars, s_yr.useful,
        s_yr.funny, s_yr.cool, s_yr.text, s_yr.timestamp
FROM STAGE.yelp_review AS s_yr
